          ...
          SingleChildScrollView(
            child: Container(
              padding: EdgeInsets.symmetric(
                  vertical: !kIsWeb ? 60 : 30, horizontal: 24),
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    "What you gonna be cooking today?",
                    style: TextStyle(
                        fontSize: 20,
                        color: Colors.white,
                  ...
                  Text(
                    "Enter your Ingridients below to get the best recipe for you ...",
                    style: TextStyle(
                        fontSize: 15,
                        color: Colors.white,
                        ...
                        InkWell(
                            onTap: () async {
                              if (textEditingController.text.isNotEmpty) {
                                ...
                                recipies = new List();
                                String url =
                                    "https://api.edamam.com/search?q=${textEditingController.text}&app_id=d565b4e1&app_key=906a6fbcff1fa25b6b8082830ec3c189";
